		...
		<table>
			...
			<C:forEach items="${requestScope.page.items}" var="music">
				...
				<tr>
					...
					<td><a href="mana/musicServlet?action=getMusic&id=${music.id}&pageNo=${requestScope.page.pageNo}">修改</a></td>
					<td><a class="deleteClass" href="mana/musicServlet?action=delete&id=${music.id}&pageNo=${requestScope.page.pageNo}">删除</a></td>
				</tr>
