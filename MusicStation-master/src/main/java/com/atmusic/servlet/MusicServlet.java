...
//        req.getRequestDispatcher("manager/musicServlet?action=page").forward(req,resp);存在bug，应使用重定向
        resp.sendRedirect(req.getContextPath() + "/mana/musicServlet?action=page&pageNo=" + pageNo);
    ...
    protected void delete(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect(req.getContextPath() + "/mana/musicServlet?action=page&pageNo="+req.getParameter("pageNo"));
    ...
    protected void page(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //设置url
        page.setUrl("mana/musicServlet?action=page");
